...
import SpringDB.Model.*;
import SpringDB.Service.ProductService;
import SpringDB.Service.ClientService;
import SpringDB.Service.OrderService;
...
public class SpringBootStarter implements CommandLineRunner {
    ...
    public void run(String... args) {
      ...
      /* log.info("find by product`s name");
        productService.findByName("Наушники").forEach(System.out::println);*/
       ...
       /* log.info("save new book");
        ...
        log.info("find all buying products since 01.03.2019");
